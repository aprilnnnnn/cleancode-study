...
public class PaySingleHourlyEmployeeWithTimeCardsSpanningTwoPayPeriod {
    private PayrollDatabase payrollDatabase = new PayrollDatabase();

    @Test
    public void PaySingleHourlyEmployeeWithTimeCardsSpanningTwoPayPeriod() {
        ...
        payCalendar2.set(2023, Calendar.OCTOBER, 5);
